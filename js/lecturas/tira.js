// Lecturas · Tira cómica (10 lecturas para 5º-6º)
window.LECTURAS = window.LECTURAS || {};
window.LECTURAS["tira"] = [
  {
    id: "tira-01-ultima-croqueta",
    titulo: "La última croqueta",
    subtipo: "Tira cómica familiar",
    curso: "5º",
    ...
    texto: [
      ...
      { vinetas: [
        ...
        { escena: "Sofía y Dani se miran fijamente, muy educados.", bocadillos: [
          ...
          { quien: "Dani", t: "No, no, cógela tú, que eres la mayor.", forma: "dice" },
        ] },
        { escena: "Primer plano de Sofía, con los ojos entrecerrados.", bocadillos: [
          { quien: "Sofía", t: "Si la cojo, luego me llamará glotona toda la semana…", forma: "piensa" },
        ] },
    ...
    vocabulario: [
      { p: "glotón", d: "que come mucho y con ansia" },
  ...
  {
    id: "tira-02-mi-perro-se-los-comio",
    titulo: "¡Mi perro se los comió!",
    subtipo: "Tira cómica escolar",
    curso: "5º",
    fuente: "Texto original",
    ...
    texto: [
      ...
      { vinetas: [
        ...
        { escena: "Julián coge el cuaderno y lo abre. Las hojas están en blanco. Dani se hunde en la silla.", bocadillos: [
          { quien: "Julián", t: "Pues ni mordido ni hecho, Dani.", forma: "dice" },
        ] },
  ...
  {
    id: "tira-03-ramona-la-planta",
    titulo: "Ramona, la planta de clase",
    subtipo: "Tira cómica escolar",
    curso: "5º",
    fuente: "Texto original",
  ...
  {
    id: "tira-04-aceitunas-del-arbol",
    titulo: "Aceitunas recién cogidas",
    subtipo: "Tira cómica",
    curso: "5º",
    fuente: "Texto original",
  ...
  {
    id: "tira-05-abuela-videollamada",
    titulo: "La abuela en videollamada",
    subtipo: "Tira cómica familiar",
    curso: "5º",
    fuente: "Texto original",
    ...
    texto: [
      ...
      { vinetas: [
        ...
        { escena: "En la pantalla aparece, enorme, una oreja con un pendiente.", bocadillos: [
          { quien: "Abuela Maruja", t: "¿Hola? ¿Hola? ¡No se oye nada!", forma: "grita" },
        ] },
        ...
        { escena: "Por fin aparece la cara de la abuela, pero muy de cerca: solo se le ve un ojo gigante.", bocadillos: [
    ...
    vocabulario: [
      { p: "encuadrar", d: "colocar bien la imagen dentro de la pantalla o de la foto" },
  ...
  {
    id: "tira-06-levante-en-la-playa",
    titulo: "Día de levante",
    subtipo: "Tira cómica",
    curso: "5º-6º",
    fuente: "Texto original",
  ...
  {
    id: "tira-07-defensa-en-zona",
    titulo: "Defensa en zona",
    subtipo: "Tira cómica deportiva",
    curso: "5º-6º",
    fuente: "Texto original",
    ...
    texto: [
      ...
      { vinetas: [
        ...
        { escena: "Marcos, que es su primer partido, levanta el pulgar muy convencido.", bocadillos: [
          ...
          { quien: "Marcos", t: "¿En zona? ¿En qué zona?", forma: "piensa" },
        ] },
  ...
  {
    id: "tira-08-robot-y-gata",
    titulo: "El robot y la gata",
    subtipo: "Tira cómica",
    curso: "5º-6º",
    fuente: "Texto original",
    ...
    texto: [
      ...
      { vinetas: [
        { escena: "Salón. Aitana deja en el suelo un robot aspirador redondo nuevo. En el sofá, la gata Canela lo observa con desconfianza.", bocadillos: [
          ...
          { quien: "Canela", t: "¿Un plato que se mueve? Sospechoso.", forma: "piensa" },
        ] },
    ...
    vocabulario: [
      { p: "desconfianza", d: "falta de confianza; sospecha" },
  ...
  {
    id: "tira-09-silencio-en-donana",
    titulo: "Silencio en Doñana",
    subtipo: "Tira cómica",
    curso: "6º",
    fuente: "Texto original",
    ...
    texto: [
      ...
      { vinetas: [
        ...
        { escena: "Álex da la vuelta a los prismáticos y ve de golpe un flamenco enorme, muy cerca.", bocadillos: [
          { quien: "Álex", t: "¡¡HALA, UN FLAMENCOOOO!!", forma: "grita" },
        ] },
    ...
    vocabulario: [
      { p: "observatorio", d: "caseta desde la que se observan animales sin molestarlos" },
      { p: "prismáticos", d: "instrumento con dos lentes para ver de cerca lo que está lejos" },
      { p: "enea", d: "planta de hojas largas que crece en lagunas y charcas" },
  ...
  {
    id: "tira-10-tutorial-diez-segundos",
    titulo: "Tutorial en diez segundos",
    subtipo: "Tira cómica",
    curso: "6º",
    fuente: "Texto original",
    ...
    texto: [
      { vinetas: [
        ...
        { escena: "Mario lanza el edredón por el aire: ¡FLUSH! El edredón le cae encima de la cabeza.", bocadillos: [
          { quien: "Mario", t: "Esto… corten. Toma dos.", forma: "dice" },
        ] },
    ...
    vocabulario: [
      { p: "tutorial", d: "vídeo o texto que enseña a hacer algo paso a paso" },
      { p: "toma", d: "cada vez que se graba de nuevo una misma escena" },
